...
export const pizzas = [
  ...
  {
    desc: "Pizza de pan plano con ingredientes seleccionados horneada a alta temperatura.",
    id: "P002",
  ...
  {
    desc: "Pizza de pan plano cubierta con mozzarella, tomates y salame, horneada en horno de leña.",
    id: "P003",
  ...
  {
    desc: "Pizza con salame, aceitunas y champiñones, ofreciendo una combinación perfecta de sabores.",
    id: "P004",
  ...
  {
    desc: "Pizza con bacon y tomates cherry, una deliciosa opción para los amantes del tocino.",
    id: "P005",
  ...
  {
    desc: "Pizza con pollo picante, pimientos y mozzarella, una combinación explosiva de sabor.",
    id: "P006",
    img: "https://firebasestorage.googleapis.com/v0/b/apis-varias-mias.appspot.com/o/pizzeria%2Fpizza-2000595_640_c.jpg?alt=media&token=61325b6e-a1e0-441e-b3b5-7335ba13e8be",
